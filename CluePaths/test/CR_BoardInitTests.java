...
public class CR_BoardInitTests {
	...
	public static void setUp() {
		board = new Board("clueGame/ClueLayout.csv", "clueGame/ClueLegend.txt");
		try {
	...
	public void testBadColumns() throws BadConfigFormatException, FileNotFoundException {
		...
		Board b = new Board("clueGame/ClueLayoutBadColumns.csv", "clueGame/ClueLegend.txt");
	...
	public void testBadRoom() throws BadConfigFormatException, FileNotFoundException {
		...
		Board b = new Board("clueGame/ClueLayoutBadRoom.csv", "clueGame/ClueLegend.txt");
		//b.loadRoomConfig();
		//b.loadBoardConfig();
		b.loadConfigFiles();
	}
	...
	public void testBadRoomFormat() throws BadConfigFormatException, FileNotFoundException {
		// overloaded Board ctor takes config file name
		Board b = new Board("clueGame/ClueLayout.csv", "clueGame/ClueLegendBadFormat.txt");
		b.loadRoomConfig();
		b.loadBoardConfig();
	}
}
